...
class TestValidatorFunctional(unittest.TestCase):
    ...
    def test_resource(self):
        ...
        self.assertRaises(AssertionError, validator.resources('aws_instance').property('value').should_equal,2)
    ...
    def test_nested_resource(self):
        ...
        self.assertRaises(AssertionError, validator.resources('aws_instance').property('nested_resource').property('value').should_equal,2)
    ...
    def test_resource_not_equals(self):
        ...
        self.assertRaises(AssertionError, validator.resources('aws_instance').property('value').should_not_equal,1)
    ...
    def test_nested_resource_not_equals(self):
        ...
        self.assertRaises(AssertionError,validator.resources('aws_instance').property('nested_resource').property('value').should_not_equal,1)
    ...
    def test_resource_required_properties(self):
        ...
        self.assertRaises(AssertionError, validator.resources('aws_instance').should_have_properties,required_properties)
    ...
    def test_nested_resource_required_properties(self):
        ...
        required_properties = ['value', 'value2', 'abc123', 'def456']
        self.assertRaises(AssertionError, validator.resources('aws_instance').property('nested_resource').should_have_properties,required_properties)
    ...
    def test_resource_property_value_matches_regex(self):
        ...
        self.assertRaises(AssertionError, validator.resources('aws_instance').property('value').should_match_regex,'[a-z]')
    ...
    def test_nested_resource_property_value_matches_regex(self):
        ...
        self.assertRaises(AssertionError, validator.resources('aws_instance').property('nested_resource').property('value').should_match_regex,'[a-z]')
    ...
    def test_missing_variable_substitution(self):
        ...
        self.assertRaises(t.TerraformVariableException, validator.resources('aws_instance').property('value').should_equal,1)
    ...
    def test_searching_for_property_value_using_regex(self):
        ...
        self.assertRaises(AssertionError,validator.resources('aws_instance').find_property('^CPM_Service_[A-Za-z]+$').should_equal,2)
    ...
    def test_searching_for_nested_property_value_using_regex(self):
        ...
        self.assertRaises(AssertionError,validator.resources('aws_instance').property('tags').find_property('^CPM_Service_[A-Za-z]+$').should_equal,2)
    ...
    def test_resource_type_list(self):
        ...
        self.assertRaises(AssertionError,validator.resources(['aws_instance','aws_elb']).property('value').should_equal,2)
    ...
    def test_nested_resource_type_list(self):
        ...
        self.assertRaises(AssertionError,validator.resources(['aws_instance', 'aws_elb']).property('tags').property('value').should_equal,2)
    ...
    def test_multiple_variable_substitutions(self):
        ...
        self.assertRaises(AssertionError,validator.resources('aws_instance').property('value').should_equal,21)
    ...
    def test_nested_multiple_variable_substitutions(self):
        ...
        self.assertRaises(AssertionError,validator.resources('aws_instance').property('value_block').property('value').should_equal,12)
    ...
    def test_variable_expansion(self):
        ...
        self.assertRaises(AssertionError,validator.resources('aws_instance').property('value').should_equal,'${bar.var}')
    ...
    def test_resource_name_matches_regex(self):
        ...
        self.assertRaises(AssertionError,validator.resources('aws_instance').name_should_match_regex,'^[a-z0-9_]*$')
    ...
    def test_encryption_scenario(self):
        ...
        validator.resources("aws_db_instance_valid").property("storage_encrypted").should_equal(True)
        self.assertRaises(AssertionError, validator.resources("aws_db_instance_invalid").should_have_properties,"storage_encrypted")
        self.assertRaises(AssertionError, validator.resources("aws_db_instance_invalid").property("storage_encrypted").should_equal, "True")
        ...
        validator.resources("aws_instance_valid").property('ebs_block_device').property("encrypted").should_equal(True)
        self.assertRaises(AssertionError, validator.resources("aws_instance_invalid").should_have_properties, "encrypted")
        self.assertRaises(AssertionError, validator.resources("aws_instance_invalid").property('ebs_block_device').property("encrypted").should_equal, "True")
        self.assertRaises(AssertionError, validator.resources("aws_instance_invalid2").should_have_properties, "storage_encrypted")
        ...
        validator.resources("aws_ebs_volume_valid").property("encrypted").should_equal(True)
        self.assertRaises(AssertionError, validator.resources("aws_ebs_volume_invalid").should_have_properties,"encrypted")
        self.assertRaises(AssertionError, validator.resources("aws_ebs_volume_invalid").property("encrypted").should_equal, "True")
        self.assertRaises(AssertionError, validator.resources("aws_ebs_volume_invalid2").should_have_properties, "encrypted")
